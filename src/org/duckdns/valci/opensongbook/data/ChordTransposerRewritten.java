...
/*
	String [] scaleArray = {"C","Cb","C#","D","Db","D#","E","Eb","E#","F","Fb","F#","G","Gb","G#",
			         "A","Ab","A#","B","Bb","B#"};
	ArrayList <String> scale = new  ArrayList<String>(Arrays.asList(scaleArray));
	String [] transpArray = {"Cb","C","C#","Bb","Cb","C","C","C#","D","Db","D","D#","C","Db","D",
		                 "D","D#","E","Eb","E","F","D","Eb","E", "E","E#","F#", "E","F","F#",
		                 "Eb","Fb","F","F","F#","G","Gb","G","G#","F","Gb","G", "G","G#","A", 
		                 "Ab","A","A#","G","Ab","A","A","A#","B","Bb","B","C","A","Bb","B", 
		                 "B","B#","C#"};
	ArrayList <String> transp = new  ArrayList<String>(Arrays.asList(transpArray));
	...
	ArrayList <String> chordParticles = new ArrayList<String>();
	while (matcher.find() ) {
		System.out.println("here we are");
	    // Do something with the matched text
		chordParticles.add(matcher.group(0));
	}
	
	System.out.println(chordParticles);
	
	for (String chordParticle : chordParticles){
		if(scale.indexOf(chordParticle)!=-1){
			if(ammount>0){
				for (int i=0;i<ammount;i++){
					int pos = scale.indexOf(chordParticles);
					//String transpos = 3*pos-2+3;
...
*/
	...
	function transposechord(chord, amount){
           ...
           // za svaki element u polju
		   for(var ax in subst){
		   // ako se nalazi u skali 
