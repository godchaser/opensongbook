...
public class SongExporter {
	...
	public static void exportOpensongFolderToOpenSongbook(
			String opensongDirectory) throws IOException,
		...
		for (int i = 0; i < files.length; i++) {
			if (files[i].isFile()) {
				...
				SongExporter.exportOpensongFileToOpenSongbook(files[i]
						.getCanonicalPath());
			}
		}
	}

	public static void exportOpensongFileToOpenSongbook(String fileName)
