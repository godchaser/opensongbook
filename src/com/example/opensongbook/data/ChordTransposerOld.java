	...
	public static void transpose (String chordLine){
		...
		for (String chord:chords){
			...
			switch (chord.toLowerCase().substring(0, 1) ) {
				case "c": System.out.println("transposing");
				break;
				case "d": System.out.println("transposing");
				break;
				case "e": System.out.println("transposing");
				break;
				case "f": System.out.println("transposing");
				break;
				case "g": System.out.println("transposing");
				break;
				case "a": System.out.println("transposing");
				break;
				case "h": System.out.println("transposing");
				break;
				case "b": System.out.println("transposing");
				break;
			}
		}
	}	
	public static String transposeChord (String chord, int ammount){
		String[] scale = {"C","Cb","C#","D","Db","D#","E","Eb","E#","F","Fb","F#","G","Gb","G#",
		                   "A","Ab","A#","B","Bb","B#"};
		String[] trans = {"Cb","C","C#","Bb","Cb","C","C","C#","D","Db","D","D#","C","Db","D",
